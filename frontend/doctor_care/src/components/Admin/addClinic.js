        ...
        <div className="modal-content">
          ...
          <div className="modal-body">
            <form onSubmit={handleSubmit} className="user-form">
                ...
                <div className="col-12">
                  <div className="textb">
                    <input
                      ...
                      required
                    />
                    <div className="placeholder">Tên phòng khám</div>
                  ...
                  <div className="textb">
                    <input
                      ...
                      onChange={async (e) => {
                        ...
                        let newValue = {
                          ...state.values,
                          ["image"]: `${domainImage}/${e.target.files[0].name}`,
                        };
                  ...
                  <div className="textb">
                    <textarea
                      ...
                      required
                    />
                    <div className="placeholder">Địa chỉ</div>
                    <span className="text-danger">
              ...
              <button
                data-toggle="modal"
                data-target="#addClinicInfoModal"
                onClick={() => {
          ...
          <button type="button" className="btn btn-default btn-prev">Prev</button>
          <button type="button" className="btn btn-default btn-next">Next</button>
        </div>
      </div>
    </div>
  );
